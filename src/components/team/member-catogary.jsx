                ...
                <table className="min-w-full divide-y divide-gray-300">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" className="whitespace-nowrap py-3.5 px-3 sm:px-4 text-left text-sm font-semibold text-gray-900">{date}</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                        {memberDatas.map(({name, degree, date, first_job}, index) => (
                            <tr key={index}>
                                ...
                                <td className="whitespace-nowrap py-3.5 px-3 sm:px-4 text-sm text-gray-500">{date}</td>
